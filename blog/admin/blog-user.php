...
if(isset($_GET['deluser'])){ 
  ...
  if($_GET['deluser'] !='1'){
    ...
    $stmt = $db->prepare('DELETE FROM tecnobloguser WHERE userId = :userId') ;
...
<link rel="stylesheet" href="assets/css-min2.css">

  <title>Users-Hamro news</title>
  ...
  <tr>
   ...
   <?php
    try {
      ...
      $stmt = $db->query('SELECT userId, username, email FROM tecnobloguser ORDER BY userId');
