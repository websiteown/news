...
<?php include("head.php");  ?>
    <title>Update Article-Hamronews</title>
...
try {
    ...
    $stmt = $db->prepare('UPDATE tecnoblog SET articleTitle = :articleTitle,  articleDescript = :articleDescrip, articleContent = :articleContent WHERE articleId = :articleId') ;
$stmt->execute(array(
